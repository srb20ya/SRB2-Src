...
typedef enum
{
	...
	GS_INTRO,                   // Introduction Tails 02-15-2002
	GS_INTRO2,                  // Introduction Tails 02-15-2002
	GS_CUTSCENE,                // Custom Cutscene Tails 08-03-2003
	GS_DEMOEND,                 // Demo End Screen Tails 09-01-2002
	GS_TITLESCREEN,             // De-Demo'd Title Screen Tails 11-30-2002
	GS_CREDITS,                 // The credit sequence Tails 05-05-2003
    //legacy
