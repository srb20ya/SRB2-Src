...
//-----------------------------------------------------------------------------
//
// $Id: win_vid.c,v 1.20 2001/08/06 23:57:11 stroggonmeth Exp $
//
...
consvar_t       cv_stretch = {"stretch","0",CV_SAVE|CV_NOSHOWHELP,CV_OnOff};
...
void I_LoadingScreen ( LPCSTR msg )
{
    ...
    if ( msg ) {
        ...
        SetTextColor ( hDCMain, RGB(0x00,0x00,0x00) ); // Tails 12-01-2002
...
/*
	...
	if(!(width == 1900 || width == 1280 || width == 640 || width == 320))
		goto skip;
	if(!(height == 1200 || height == 800 || height == 400 || height == 200))
		goto skip;
*/
