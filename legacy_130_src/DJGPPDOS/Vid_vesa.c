...
//-----------------------------------------------------------------------------
//
// $Id: Vid_vesa.c,v 1.2 2000/02/27 00:42:11 hurdler Exp $
//
...
int VID_VesaGetModeInfo (int modenum)
{
    ...
    else
    {
		...
		// Eliminate non-aspect video modes Tails 03-25-2001
		if(!(vesamodeinfo.XResolution == 640 || vesamodeinfo.XResolution == 320))
			return false;
		if(!(vesamodeinfo.YResolution == 400 || vesamodeinfo.YResolution == 200))
			return false;
