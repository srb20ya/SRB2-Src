...
echo "\n";
echo "\n";
echo '  <channel rdf:about="http://srb2.servegame.org/srb2ms_status.php">';
echo "\n";
...
//        $fd = 0;
	...
	else
	{
		echo '<items>';
		echo '<rdf:Seq>';
		echo '<rdf:li rdf:resource="http://srb2.servegame.org/srb2ms_status.php" />';
		echo '</rdf:Seq>';
		echo '</items>';
		echo '</channel>';
		echo "\n";
		echo '<item rdf:about="http://srb2.servegame.org/srb2ms_status.php"> ';
