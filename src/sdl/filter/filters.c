...
SDLCALL SDL_Surface *filter_2xe(SDL_Surface *src, SDL_Rect *srcclp, filter_2 filter,Uint8 R, Uint8 G, Uint8 B)
{
	...
	{
		dstclp.w = src->w; //src's width
		dstclp.h = src->h; //src's height
	}
...
SDLCALL void filter_super2xsai(Uint8 *srcPtr, Uint32 srcPitch,
...
SDLCALL void filter_supereagle(Uint8 *srcPtr, Uint32 srcPitch, /* Uint8 *deltaPtr,  */
...
SDLCALL void filter_2xsai (Uint8 *srcPtr, Uint32 srcPitch,
	     Uint8 *dstPtr, Uint32 dstPitch, int width, int height)
{
    Uint8  *dP;
    Uint16 *bP;
...
SDLCALL void filter_advmame2x(Uint8 *srcPtr, Uint32 srcPitch, 
                      Uint8 *dstPtr, Uint32 dstPitch,
							        int width, int height)
{
...
SDLCALL void filter_tv2x(Uint8 *srcPtr, Uint32 srcPitch, 
                 Uint8 *dstPtr, Uint32 dstPitch, 
                 int width, int height)
{
...
SDLCALL void filter_normal2x(Uint8 *srcPtr, Uint32 srcPitch, 
               Uint8 *dstPtr, Uint32 dstPitch, 
               int width, int height)
{
	unsigned int nextlineSrc = srcPitch / sizeof(Uint16);
...
SDLCALL void filter_scan50(Uint8 *srcPtr, Uint32 srcPitch, 
                   Uint8 *dstPtr, Uint32 dstPitch, 
                   int width, int height)
{
...
SDLCALL void filter_scan100(Uint8 *srcPtr, Uint32 srcPitch, 
                    Uint8 *dstPtr, Uint32 dstPitch, 
                    int width, int height)
{
  unsigned int nextlineSrc = srcPitch / sizeof(Uint16);
...
SDLCALL void filter_dotmatrix(Uint8 *srcPtr, Uint32 srcPitch, 
                      Uint8 *dstPtr, Uint32 dstPitch,
					            int width, int height)
{
	unsigned int nextlineSrc = srcPitch / sizeof(Uint16);
...
SDLCALL void filter_bilinear(Uint8 *srcPtr, Uint32 srcPitch, 
                     Uint8 *dstPtr, Uint32 dstPitch, 
                     int width, int height)
{
  unsigned int nextlineSrc = srcPitch / sizeof(Uint16);
...
SDLCALL void filter_bicubic(Uint8 *srcPtr, Uint32 srcPitch, 
                    Uint8 *dstPtr, Uint32 dstPitch, 
                    int width, int height)
{
  unsigned int nextlineSrc = srcPitch / sizeof(Uint16);
