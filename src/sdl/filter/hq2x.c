...
inline void Interp9(Uint8 * pc, int c1, int c2, int c3)
{
#ifdef HQ2XMMXASM
...
inline void Interp10(Uint8 * pc, int c1, int c2, int c3)
{
#ifdef HQ2XMMXASM
...
inline int Diff(Uint32 w1, Uint32 w2)
{
#ifdef HQ2XMMXASM
 if(hasMMX)
 {
...
void hq2x_32( Uint8 * pIn, Uint8 * pOut, int Xres, int Yres, int BpL )
{
  int  i, j, k;
