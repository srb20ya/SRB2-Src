...
SDLCALL void hq2x16(Uint8 *srcPtr, Uint32 srcPitch, Uint8 *dstPtr,
...
SDLCALL void hq2x32(Uint8 *srcPtr, Uint32 srcPitch, Uint8 *dstPtr,
             Uint32 dstPitch, int width, int height)
{
...
SDLCALL void lq2x16(Uint8 *srcPtr, Uint32 srcPitch, Uint8 *dstPtr,
           Uint32 dstPitch, int width, int height)
{
  Uint16 *dst0 = (Uint16 *)dstPtr;
  Uint16 *dst1 = dst0 + (dstPitch >> 1);
...
SDLCALL void lq2x32(Uint8 *srcPtr, Uint32 srcPitch, Uint8 *dstPtr,
             Uint32 dstPitch, int width, int height)
{
  Uint32 *dst0 = (Uint32 *)dstPtr;
  Uint32 *dst1 = dst0 + (dstPitch >> 2);
...
void hq2x_init(Uint32 bits_per_pixel)
{
